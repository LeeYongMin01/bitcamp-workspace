...
// # 정수 리터럴 - 자릿수 표기
// - 정수를 읽기 쉽도록 밑줄(underscore; _)을 숫자 사이에 삽입할 수 있다. = 언더바
...
public class Exam0220{
    ...
    // 숫자 맨 앞 또는 맨 뒤에는 삽입 못함
    // ex) System.out.println(_12783406);
    // ex) System.out.println(12783406_);
