...
public class Exam0422 {
  public static void main(String[] args) {
    ...
    // 10진수로 부동소수점을 표현할 경우 소수점을 제외한 숫자가 15개인 경우
    // 정상적으로 메모리에 저장된다는 의미
    ...
    d = 0.00000999999999988888; // 소수점을 떼면 숫자가 21개 이지만, 앞의 0을 제외하면 실제 17개이다.
    System.out.println(d); // OK
    
    // 주의
    // 유효자릿수가 15자리를 넘어가면 정상적으로 값이 저장되지 않을 수 있다.
    ...
    // 주의 
    // 유효자릿수는 부동소수점의 저장 가능 여부를 간단히 계산하기 위해 나온 개념이다.
    // 실제로 유효자릿수에 해당하는 부동소수점이라도 정규화 과정을 통해 2진수로 변환되는 과정에서
    // 값이 잘리는 경우가 있음
