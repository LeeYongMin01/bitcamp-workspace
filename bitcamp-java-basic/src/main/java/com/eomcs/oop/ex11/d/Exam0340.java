...
public class Exam0340 {
  public static void main(final String[] args) {
    ...
    // A 객체는 Runner 규칙에 따라 만들었기 때문에 Runner 레퍼런스에 저장할 수 있다.
    // 이 레퍼런스를 사용하여 A 객체의 run() 메서드를 호출해보자
    r.run();
  }
  
  Runner createRunner(final String name) {
    // Exam0340 객체 주소를 받는 내장 변수 this가 있다.
