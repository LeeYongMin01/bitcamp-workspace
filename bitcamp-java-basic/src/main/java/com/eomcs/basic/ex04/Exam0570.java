...
public class Exam0570 {
  public static void main(String[] args) {
    ...
    // int arr2[] = new int[5](0, 0, 0, 0, 0}; // 문법 오류. 배열 개수를 지정하면 안됨
    
    // 2) 배열 선언 + 초기화 명령 2 
    int arr3[] = {0, 0, 0, 0, 0}; // new int[]는 생략 가능
    
    // 그러나 배열 변수를 선언한 후 따로 초기화 시킬 때는 
...
//    - 배열 메모리를 초기화 시킬 때는 배열 개수를 지정해서는 안됨
//    - 배열을 초기화 시키는 값의 개수 많큼 메모리가 만들어진다.
//    -즉, 다음은 값 개수많큼 int 메모리가 3개가 생성된다.
...
//       - 변수를 선언한 후 따로 배열을 초기화 시킬 때는 new 명령을 생략할 수 없다.
