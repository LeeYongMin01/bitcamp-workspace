...
public class Exam0250 {
  static class Calculator {
    ...
    static void plus(Calculator obj, int value) {
      // 인스턴스 변수를 다루는 메서드는 작업을 수핼할 때 그 인스턴스 주소를 받아야 한다.
    ...
    // 식1의 계산 결과는 c1인스턴스의 result 변수에 들어있고,
    // 식2의 계산 결과는 c2인스턴스의 result 변수에 들어있다.
