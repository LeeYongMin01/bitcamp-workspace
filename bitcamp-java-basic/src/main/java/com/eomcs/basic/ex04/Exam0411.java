...
public class Exam0411 {
  public static void main(String[] args) {
    ...
    //다음은 값을 저장할 메모리의 크기 때문에 발생한 오류가 아님
    //리터럴 크기의 문제다.
    //정수 값 뒤에 L 또는 l을 붙이지 않은 리터럴은 4바이트 크기를 의미한다.
    // 그런데 4바이트를 넘어서는 값을 리터럴로 표현했기 때문에 오류가 발생한 것이다.
    //i = -2147483649; // 컴파일 오류
    //i = 2147483648; // 컴파일 오류
    
    //해결책
    // 4byte 크기를 벗어나는 정수를 표기할 때는 반드시 숫자 뒤에 L 또는 l을 붙여야 한다.
    //i = -2147483649L; // 메모리의 크기가 4바이트라서 값을 저장할 수 없다. int데이터 타입 이상의 값
    //i = 2147483649L;
