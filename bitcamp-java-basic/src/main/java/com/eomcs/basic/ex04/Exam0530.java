...
public class Exam0530 {
  public static void main(String[] args) {
    ...
    //  - 즉 연속된 5개의 int 타입 메모리를 준비하라는 명령이다.
    //  - 사용할 메모리를 확보한 후 그 메모리로 찾아갈 수 있도록 시작 주소를 리턴한다.
    ...
    arr1[0] = 100; // arr1에 저장된 주소로 찾아가서 0번째 항목에 값을 넣으라는 뜻
    arr1[1] = 200; // arr1에 저장된 주소로 찾아가서 1번째 항목에 값을 넣으라는 듯
