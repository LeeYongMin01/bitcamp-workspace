...
public class Exam0910 {
  public static void main(String[] args) {
    ...
    // 하지만 실행시에 float 메모리에 저장되는 과정에서
    // 유효자릿수가 넘어가는 값은 잘린다.
    // =컴파일러에는 문제 x but 유효자릿수가 넘어가면 잘림
    
    l = 200_1234_3654L;
    f2 = l;
    System.out.println(f2); // 위와 같은 케이스
    
    // 부동소수점 ==> 정수 변수
    // *****부동소수점에 정수 변수에 저장할 수 없다.*****
    //
    f = 112.123f;
...
//    bool = (boolean) c; 
    ...
    // 형변환 하려면 이렇게 명시적 형변환으로 해야됨 단, 값이 짤리는건 감수 해야함
