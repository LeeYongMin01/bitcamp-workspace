...
public class Exam0210_class {
  ...
  static class A {
    ...
    static void m1() {
      ...
      // 스태틱 메서드는 this라는 내장 변수가 존재하지 않는다
      // this.v2= 200;
      // v2 = 200;
      // 스태틱 메서드는 this라는 내장 변수가 없기 때문에
      // this 를 사용하여 접근하는 인스턴스 멤버(필드, 메서드)를
      // 사용할 수 없다.
    ...
    void m2() {
      ...
      // 그러나 권장하지 않음
      // 다른 개발자들에게 혼동을 유발할 수 있기 때문
      this.v1 = 100; // => A.v1 = 100;
      v1 = 200; // => A.v1 = 200; // 클래스 이름을 생략할 수 있다
      A.v1 = 200;
  ...
  public static void main(String[] args) {
    A.m1();
// A.m2(); // non-static 메서드는 인스턴스가 있어야만 호출 가능
// => 인스턴스 메서드
    A obj1 = new A();
    obj1.m2();
